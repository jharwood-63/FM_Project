...
public class Data {
    ...
    public Data() {
        ...
        try {
            ...
            fNames = deserializer.deserializeNames("ServerResources/json/fnames.json");
            mNames = deserializer.deserializeNames("ServerResources/json/mnames.json");
            sNames = deserializer.deserializeNames("ServerResources/json/snames.json");
        }
        catch (IOException e) {
            e.printStackTrace();
        }
